    ...
    <div className="">
      ...
      <header className="fixed top-0 left-0 w-full bg-gray-800 text-white p-4 z-50 flex justify-between items-center">
        <h1 className="text-2xl md:text-3xl font-extrabold ">
          <span className="text-teal-500">BIDISHA</span> <span className="text-gray-200">GARAI </span>
        </h1>
        <button
          className="md:hidden "
        ...
        <section id="about" className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-r from-gray-100 to-gray-200 p-4 md:p-8 mb-4 pt-16 relative overflow-hidden">
          <div className="flex-1 md:mr-8 p-4 md:p-6 relative text-center md:text-left">
            ...
            <p className="text-gray-700 leading-relaxed text-sm md:text-base lg:text-lg mx-auto md:mx-0">
              Hi, I'm Bidisha Garai, a Java Developer with a passion for creating robust and scalable applications. I completed my Master of Computer Applications (MCA) in 202 and have since been dedicated to expanding my knowledge and skills in software development.
              <br /><br />
            ...
            <a href="/portfolio/bidisha.pdf" download="Bidisha Resume">
          ...
          <div className="flex-1  md:mt-0 flex justify-center">
            <img src="https://media.licdn.com/dms/image/v2/C5103AQHe3rDVeBT-Mg/profile-displayphoto-shrink_200_200/profile-displayphoto-shrink_200_200/0/1582720802764?e=2147483647&v=beta&t=bvDg3D0KTqk4lFFx65788FwMh1B33_iAIZM0nGbDKb4" alt="Profile" className="w-80 h-80 md:w-64 md:h-64 lg:w-80 lg:h-80 rounded-full border-4 border-gray-300 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl" />
          </div>
        </section>
